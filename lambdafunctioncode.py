"""
This code is what is used for the AWS lambda function that we created. No need to run this file to use the program.
"""
...
def lambda_handler(event, context):
    ...
    return json.loads(json.dumps(kvs, default=str))
